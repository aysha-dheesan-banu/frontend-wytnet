...
const CLIENT_ID = 'YOUR_REGULATION_CLIENT_ID'; 
const REDIRECT_URI = `${window.location.origin}/regulation-assistant/dashboard.html`; 
    ...
    if (code) {
        ...
        fetch(`${PROJECT1_URL}/oauth/token`, {
            ...
            body: new URLSearchParams({
                ...
                code: code,
                client_id: CLIENT_ID,
                client_secret: 'YOUR_REGULATION_CLIENT_SECRET', 
